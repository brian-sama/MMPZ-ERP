-- MMPZ Consolidated Database Setup Script
-- Includes: Schema definitions, indexes, and initial seed data
-- 1. DROP EXISTING TABLES (Optional, for clean setup)
DROP TABLE IF EXISTS kobo_submissions CASCADE;
DROP TABLE IF EXISTS kobo_form_links CASCADE;
DROP TABLE IF EXISTS notifications CASCADE;
DROP TABLE IF EXISTS activities CASCADE;
DROP TABLE IF EXISTS progress_updates CASCADE;
DROP TABLE IF EXISTS indicators CASCADE;
DROP TABLE IF EXISTS users CASCADE;
DROP TABLE IF EXISTS kobo_config CASCADE;
...
-- 3. SEED INITIAL DATA (From seed.sql)
...
VALUES (
        ...
        'system',
        'Welcome to MMPZ',
        'Your M&E system is now set up and ready to use.',
        NULL
    ),
    (
        2,
        ...
        'A progress update for Digital Literacy Campaign needs your approval.',
        1
    );
INSERT INTO kobo_config (server_url, api_token, is_connected)
VALUES ('https://kf.kobotoolbox.org', '', FALSE);